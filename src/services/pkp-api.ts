  ...
  const trains: Train[] = [
    {
      ...
      timetable: [
        {
          stationId: (neighbor1 as any).id || 101,
          stationName: neighbor1.name || 'Stacja początkowa',
          lat: neighbor1.lat,
          lng: neighbor1.lng,
          plannedDeparture: '14:15',
        ...
        },
        {
          ...
          lat: station.lat,
          lng: station.lng,
          plannedArrival: '14:38',
          plannedDeparture: '14:40',
          actualArrival: '14:38',
          actualDeparture: '14:40',
          delayMinutes: 0,
          isConfirmed: true,
          status: 'current',
        },
        {
          stationId: (neighbor2 as any).id || 102,
          stationName: neighbor2.name || 'Stacja docelowa',
          lat: neighbor2.lat,
          lng: neighbor2.lng,
    ...
    },
    {
      ...
      timetable: [
        {
          stationId: (neighbor2 as any).id || 102,
          stationName: neighbor2.name || 'Stacja początkowa',
          lat: neighbor2.lat,
          lng: neighbor2.lng,
          plannedDeparture: '13:50',
          actualDeparture: '13:53',
          delayMinutes: 3,
          isConfirmed: true,
          status: 'passed',
        },
        {
          ...
          lat: station.lat,
          lng: station.lng,
          plannedArrival: '14:22',
          plannedDeparture: '14:25',
          actualArrival: '14:25',
          actualDeparture: '14:27',
          delayMinutes: 2,
          isConfirmed: false,
          status: 'next',
        },
        {
          stationId: (neighbor1 as any).id || 101,
          stationName: neighbor1.name || 'Stacja docelowa',
          lat: neighbor1.lat,
          lng: neighbor1.lng,
          plannedArrival: '14:52',
          delayMinutes: 2,
          status: 'upcoming',
        },
      ],
